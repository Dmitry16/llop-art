...
function wpt_theme_styles() {
	...
	//wp_enqueue_style( 'normalize_css', get_template_directory_uri() . '/style.css' );
	wp_enqueue_style( 'googlefonts_css', 'http://fonts.googleapis.com/css?family=Asap:400,700,400italic,700italic' );	
	wp_enqueue_style( 'main_css', get_template_directory_uri() . '/app/production/css/todo.min.css' );
}
